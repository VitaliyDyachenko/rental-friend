...
Project uses proxy for requsts. Proxy configured in "package.json" - "proxy": "http://localhost:52133" (line #62).
For sign in to site. Please connect server and change API links. 

Or change "src/actions/index.jsx" file, "signInAction" method.
